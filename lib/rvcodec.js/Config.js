 ...
 */
export const CONFIG_TYPE = makeEnum(["BOOL", "CHOOSE_ONE"]);

/*
 * Configuration options enums
 */
export const COPTS_ISA = makeEnum(["AUTO", "RV32I", "RV64I", "RV128I"]);
...
export const configFields = {
  ISA: {
    name: "ISA",
    type: CONFIG_TYPE.CHOOSE_ONE,
    opts: Object.values(COPTS_ISA),
  },
...
export const configDefault = Object.freeze(
  Object.fromEntries(
    Object.entries(configFields).map(([k, v]) => [k, v.default ?? v.opts[0]])
  )
);
